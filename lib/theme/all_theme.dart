...
SharedPreferences? _prefs;
 ...
 class DemirBasimTheme {
  ...
  static DemirBasimTheme of(BuildContext context) {
...
class LightModeTheme extends DemirBasimTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
...
class DarkModeTheme extends DemirBasimTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
